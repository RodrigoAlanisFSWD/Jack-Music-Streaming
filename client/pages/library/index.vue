<template>
    <div class="flex flex-col w-full h-full max-h-[calc(100vh-80px)] text-white overflow-y-scroll">
        <div v-if="library && library.songs.length > 0" class="w-full p-5">
            <h2 class="text-xl my-5">
                Songs
            </h2>
            <div class="flex">
                <div v-for="song in library.songs" :key="song.id" class="flex flex-col">
        ...
        <div v-if="library && library.playlists.length > 0" class="w-full p-5">
            <h2 class="text-xl my-5">
                Playlists
            </h2>
            <div class="flex">

                <div v-for="playlist in library.playlists" :key="playlist.id" class="flex flex-col">
        ...
        <div v-if="library && library.albums.length > 0" class="w-full p-5">
            <h2 class="text-xl my-5">
                Albums
            </h2>
            <div class="flex">
                <div v-for="album in library.albums" :key="album.id" class="flex flex-col">
